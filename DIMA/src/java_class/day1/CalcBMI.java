...
public class CalcBMI {
	public static void main(String[] args) {
		...
		// height / 100; // double / int -> promotion이 일어난다. (큰 타입(=최대값이 큰 값)으로 변경
		// double > int)
		...
		//
		// System.out.printf("키가 %.2fcm이고, 몸무게가 %dKg인 사람은 BMI가 %.2f입니다.", height,
		// weight, bmi); // printf의 첫번째 전달 인자는 무조건 string
